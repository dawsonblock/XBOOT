...
class WorkerProtocolTests(unittest.TestCase):
    ...
    def test_truncated_child_payload_is_protocol_error(self):
        with tempfile.TemporaryDirectory() as tmp:
            child = Path(tmp) / 'truncated_child.py'
            child.write_text(
                "import sys\n"
                "sys.stdout.buffer.write(b'WRK1R 2 0 ok 4 0 0\\n')\n"
                "sys.stdout.buffer.write(b't1xy')\n"
